...
$wgTranslateLanguageFallbacks = [
	...
	'ban-bali' => [ 'id', 'jv' ],
	'bas' => [ 'fr', 'dua' ],
	'bax' => [ 'bax-bamu', 'fr', 'ar', 'byv' ],
	'bax-bamu' => [ 'bax', 'fr', 'ar', 'byv' ],
	...
	'cak' => [ 'es' ],
	'ccp' => [ 'bn' ],
	'cdo-hans' => [ 'cdo-hant', 'cdo-latn', 'cdo', 'cpx-hans', 'cpx-hant' ],
	'cdo-hant' => [ 'cdo-hans', 'cdo-latn', 'cdo', 'cpx-hant', 'cpx-hans' ],
	'cdo-latn' => [ 'cdo-hant', 'cdo-hans', 'cdo', 'cpx-hant', 'cpx-hans' ],
	...
	'nit' => [ 'wsg', 'te', 'hi' ],
	'njo' => [ 'as', 'hi' ],
	'nmz' => [ 'fr', 'xon', 'kbp', 'ee' ], # Only for translatewiki. Don't add these as fallback in core.
	...
	'rmc' => [ 'sk', 'cs', 'hu' ],
	'rmf' => [ 'fi' ],
	'rml-cyrl' => [ 'rmc', 'rmy', 'ru', 'be', 'be-tarask', 'uk' ],
	'rn' => [ 'fr', 'rw', 'sw' ],
	'rsk' => [ 'uk', 'ru', 'rue' ],
