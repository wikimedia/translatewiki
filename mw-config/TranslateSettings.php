...
$wgTranslateGroupFiles[] = "$GROUPS/MediaWiki/CoreAgg.yaml";
...
$wgTranslateDisabledTargetLanguages = [
	'*' => [
		...
		'ais' => 'This language code should remain unused. Localise in szy please.',
		...
		'es-419' => 'This language code should remain unused. Localise in \'es\' please.',
		...
		'ks-arab' => 'This language code should remain unused. Localise in ks please.',
	...
	'core' => [
		'de-formal' => 'This language code should remain unused. Translate into \'de\' and use the <code><nowiki>{{#FORMAL:}}</nowiki></code> syntax instead.',
	],
	'ext' => [
		'de-formal' => 'This language code should remain unused. Translate into \'de\' and use the <code><nowiki>{{#FORMAL:}}</nowiki></code> syntax instead.',
	],
...
$wgTranslateGroupFiles[] = "$GROUPS/Wikimedia/Code2CodeSearch.yaml";
...
$wgTranslateGroupFiles[] = "$GROUPS/Wikimedia/WikisourceReader.yaml";
...
$wgTranslateGroupFiles[] = "$GROUPS/Wikimedia/WikiInfographics.yaml";
...
$wgTranslateGroupFiles[] = "$GROUPS/Intuition/wikiinfo.yaml";
